...
datos_clean <- datos %>%
  transmute(
   ...
   colpropaz_sum = na_if(replace_na(colpropaz1b, 0) + replace_na(colpropaz1cn, 0) + 
...
#write_csv(datos_clean, "output/datos_lapop_2018_clean.csv")
write_rds(datos_clean, "output/datos_lapop_2018_clean.rds") # preferible
